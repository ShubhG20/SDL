...
public class MiddleEast2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_middle_east2);
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                src1= dataSnapshot.child("MiddleEast").child("Environment").child("1").child("src").getValue(String.class);

                summary1=dataSnapshot.child("MiddleEast").child("Environment").child("1").child("summary").getValue(String.class);




                src2= dataSnapshot.child("MiddleEast").child("Environment").child("2").child("src").getValue(String.class);

                summary2=dataSnapshot.child("MiddleEast").child("Environment").child("2").child("summary").getValue(String.class);


                src3= dataSnapshot.child("MiddleEast").child("Environment").child("3").child("src").getValue(String.class);

                summary3=dataSnapshot.child("MiddleEast").child("Environment").child("3").child("summary").getValue(String.class);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                models.add(new model(R.drawable.me4,src1,summary1));

                models.add(new model(R.drawable.me5,src2,summary2));

                models.add(new model(R.drawable.me6,src3,summary3));
